...
func New(apiKey, model string) (*Client, error) {
	...
	// Groq doesn't support HTTP POST compression.
...
func (c *Client) CompletionStreamRaw(ctx context.Context, in *CompletionRequest, out chan<- CompletionStreamChunkResponse) error {
	...
	in.Stream = true
	resp, err := c.c.PostRequest(ctx, "https://api.groq.com/openai/v1/chat/completions", nil, in)
	if err != nil {
...
func (c *Client) ListModels(ctx context.Context) ([]genai.Model, error) {
	...
	if err := c.c.Get(ctx, "https://api.groq.com/openai/v1/models", nil, &out); err != nil {
		return nil, err
	}
