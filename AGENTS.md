...
- **Weekly model regeneration**: `./scripts/regen_weekly.sh`
  ...
  - Required env vars: `ANTHROPIC_API_KEY`, `BASETEN_API_KEY`, `CEREBRAS_API_KEY`, `CLOUDFLARE_ACCOUNT_ID`, `CLOUDFLARE_API_KEY`, `COHERE_API_KEY`, `DEEPSEEK_API_KEY`, `GEMINI_API_KEY`, `GROQ_API_KEY`, `HUGGINGFACE_API_KEY`, `MISTRAL_API_KEY`, `OPENAI_API_KEY`, `OPENROUTER_API_KEY`, `TOGETHER_API_KEY`, `MIMO_API_KEY`, and one of `DASHSCOPE_API_KEY_INTL`, `DASHSCOPE_API_KEY_US`, `DASHSCOPE_API_KEY_CN`, or `DASHSCOPE_API_KEY`.
