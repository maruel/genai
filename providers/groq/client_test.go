...
func gc(t testing.TB, name, m string) (genai.Provider, http.RoundTripper) {
	...
	if m == "deepseek-r1-distill-llama-70b" {
		return &handleGroqReasoning{Client: c, t: t}, rt
	}
	return c, rt
}
	...
	data := []internaltest.ProviderError{
		{
			...
			ErrListModel: "http 401: error invalid_api_key (invalid_request_error): Invalid API Key. You can get a new API key at https://console.groq.com/keys",
		},
		{
			Name:         "bad model",
			Model:        "bad model",
